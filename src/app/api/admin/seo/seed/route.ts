...
const seoData = [
  // Homepage - Slovak
  {
    pageSlug: 'home',
    locale: 'sk',
    metaTitle: 'Apartmány Vita - Luxusné ubytovanie v Trenčíne',
    metaDescription: 'Moderné apartmány v centre Trenčína. WiFi, parkovanie, plne vybavené kuchyne. Rezervujte si svoj pobyt online.',
    metaKeywords: ['apartmány Trenčín', 'ubytovanie Trenčín', 'apartmány vita', 'prenájom Trenčín', 'centrum Trenčín'],
    ogType: 'website',
    ogTitle: 'Apartmány Vita - Luxusné ubytovanie v Trenčíne',
    ogDescription: 'Moderné apartmány v centre Trenčína. WiFi, parkovanie, plne vybavené kuchyne. Rezervujte si svoj pobyt online.',
    ogImage: `${BASE_URL}/og-default.jpg`,
    twitterCard: 'summary_large_image',
    twitterTitle: 'Apartmány Vita - Luxusné ubytovanie v Trenčíne',
    twitterDescription: 'Moderné apartmány v centre Trenčína. WiFi, parkovanie, plne vybavené kuchyne.',
    twitterImage: `${BASE_URL}/og-default.jpg`,
    canonicalUrl: `${BASE_URL}/sk`,
    h1Heading: 'Luxusné apartmány v srdci Trenčína',
    alternateUrls: {
      sk: `${BASE_URL}/sk`,
      en: `${BASE_URL}/en`,
      de: `${BASE_URL}/de`,
  ...
  // Apartments List - Slovak
  {
    ...
    metaDescription: 'Vyberte si z našich moderných apartmánov v centre Trenčína. Deluxe, Lite a Design varianty s plným vybavením. Od 75€ za noc.',
    metaKeywords: ['apartmány', 'ubytovanie', 'Trenčín', 'prenájom', 'deluxe', 'design', 'lite'],
    ogType: 'website',
    ogTitle: 'Naše apartmány - Apartmány Vita Trenčín',
    ...
    twitterDescription: 'Moderné apartmány s plným vybavením v centre Trenčína.',
    twitterImage: `${BASE_URL}/og-default.jpg`,
  ...
  // Contact - Slovak
  {
    ...
    metaKeywords: ['kontakt', 'apartmány vita', 'Trenčín', 'rezervácia', 'telefón', 'email'],
    ogType: 'website',
  ...
  // About - Slovak
  {
    ...
    metaDescription: 'Spoznajte Apartmány Vita - váš domov v Trenčíne. Moderné ubytovanie s osobným prístupom a výnimočnými službami.',
    metaKeywords: ['o nás', 'apartmány vita', 'Trenčín', 'história', 'služby'],
    ogType: 'website',
    ogTitle: 'O nás - Apartmány Vita',
    ogDescription: 'Spoznajte Apartmány Vita - váš domov v Trenčíne. Moderné ubytovanie s osobným prístupom.',
    ogImage: `${BASE_URL}/og-default.jpg`,
    twitterCard: 'summary_large_image',
    twitterTitle: 'O nás - Apartmány Vita',
    twitterDescription: 'Spoznajte Apartmány Vita - váš domov v Trenčíne.',
    twitterImage: `${BASE_URL}/og-default.jpg`,
