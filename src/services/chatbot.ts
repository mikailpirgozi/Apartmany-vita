...
- Kontakt: +421-940-728-676, info@apartmanvita.sk
...
export async function getChatbotResponse(
  ...
  try {
    if (!process.env.OPENAI_API_KEY) {
      return {
        message: 'Prepáčte, chatbot momentálne nie je dostupný. Kontaktujte nás prosím na +421-940-728-676 alebo info@apartmanvita.sk',
    ...
    return {
      message: 'Nastala technická chyba. Prosím kontaktujte nás priamo na +421-940-728-676 alebo info@apartmanvita.sk',
