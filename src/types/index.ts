...
export interface Beds24AvailabilityResponse {
  ...
  isAvailable: boolean
  totalPrice: number
  subtotal?: number // Price before ANY discounts
  stayDiscount?: number // Stay discount amount (7+, 14+, 30+ days)
  stayDiscountPercent?: number // Stay discount percentage (10, 15, 20)
  stayDiscountInfo?: {
    label: string
